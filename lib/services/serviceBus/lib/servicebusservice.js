...
var eventHubResult = require('./models/eventhubresult');
...
ServiceBusService.prototype.createEventHub = function (hubPath, optionsOrCallback, callback) {
  this._createResource(hubPath, eventHubResult, null, optionsOrCallback, callback);
}
